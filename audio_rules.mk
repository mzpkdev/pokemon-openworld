...
# HnS Pewter's donor-authenticated instrument sources retain their original AIF format.
$(SOUND_BIN_DIR)/direct_sound_samples/hg_%.bin: $(SOUND_BIN_DIR)/direct_sound_samples/hg_%.aif
	$(AIF) $< $@
