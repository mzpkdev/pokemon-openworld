...
static void LoadMapNamePopUpWindowBg(void)
{
    ...
    MapSectionId regionMapSectionId = gMapHeader.regionMapSectionId;
    ...
    if (OW_POPUP_GENERATION == GEN_5)
    {
        popUpThemeId = IsValidMapSectionId(regionMapSectionId)
                     ? sRegionMapSectionId_To_PopUpThemeIdMapping_BW[regionMapSectionId]
                     : MAPPOPUP_THEME_BW_DEFAULT;
        switch (popUpThemeId)
        {
    ...
    {
        popUpThemeId = IsValidMapSectionId(regionMapSectionId)
                     ? sMapSectionToThemeId[regionMapSectionId]
                     : MAPPOPUP_THEME_WOOD;
