...
static void DrawCityMap(struct Pokenav_RegionMapGfx *, MapSectionId, int);
static void PrintLandmarkNames(struct Pokenav_RegionMapGfx *, MapSectionId, int);
...
static void DrawCityMap(struct Pokenav_RegionMapGfx *state, MapSectionId mapSecId, int pos)
{
    int i;
...
static void PrintLandmarkNames(struct Pokenav_RegionMapGfx *state, MapSectionId mapSecId, int pos)
{
    int i = 0;
    while (1)
    {
