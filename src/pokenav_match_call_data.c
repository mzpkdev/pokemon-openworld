...
static MapSectionId MatchCall_GetMapSec_NPC(match_call_t);
static MapSectionId MatchCall_GetMapSec_Trainer(match_call_t);
static MapSectionId MatchCall_GetMapSec_Wally(match_call_t);
static MapSectionId MatchCall_GetMapSec_Birch(match_call_t);
static MapSectionId MatchCall_GetMapSec_Rival(match_call_t);
...
static MapSectionId (*const sMatchCallGetMapSecFuncs[])(match_call_t) = {
...
MapSectionId MatchCall_GetMapSec(u32 idx)
{
    match_call_t matchCall;
    u32 i;
...
static MapSectionId MatchCall_GetMapSec_NPC(match_call_t matchCall)
{
    return matchCall.npc->mapSec;
}

static MapSectionId MatchCall_GetMapSec_Trainer(match_call_t matchCall)
{
    return matchCall.trainer->mapSec;
}

static MapSectionId MatchCall_GetMapSec_Wally(match_call_t matchCall)
{
    s32 i;
...
static MapSectionId MatchCall_GetMapSec_Rival(match_call_t matchCall)
{
    return MAPSEC_NONE;
}

static MapSectionId MatchCall_GetMapSec_Birch(match_call_t matchCall)
{
    return MAPSEC_NONE;
}
