...
enum InGameTradeID
{
    INGAME_TRADE_SEEDOT = PERSISTENT_TRADE_STATE_INGAME_TRADE_SEEDOT,
    INGAME_TRADE_PLUSLE = PERSISTENT_TRADE_STATE_INGAME_TRADE_PLUSLE,
    INGAME_TRADE_HORSEA = PERSISTENT_TRADE_STATE_INGAME_TRADE_HORSEA,
    INGAME_TRADE_MEOWTH = PERSISTENT_TRADE_STATE_INGAME_TRADE_MEOWTH,
    // FRLG
    INGAME_TRADE_MR_MIME = PERSISTENT_TRADE_STATE_INGAME_TRADE_MR_MIME,
    INGAME_TRADE_JYNX = PERSISTENT_TRADE_STATE_INGAME_TRADE_JYNX,
    INGAME_TRADE_NIDORAN = PERSISTENT_TRADE_STATE_INGAME_TRADE_NIDORAN,
    INGAME_TRADE_FARFETCHD = PERSISTENT_TRADE_STATE_INGAME_TRADE_FARFETCHD,
    INGAME_TRADE_NIDORINOA = PERSISTENT_TRADE_STATE_INGAME_TRADE_NIDORINOA,
    INGAME_TRADE_LICKITUNG = PERSISTENT_TRADE_STATE_INGAME_TRADE_LICKITUNG,
    INGAME_TRADE_ELECTRODE = PERSISTENT_TRADE_STATE_INGAME_TRADE_ELECTRODE,
    INGAME_TRADE_TANGELA = PERSISTENT_TRADE_STATE_INGAME_TRADE_TANGELA,
    INGAME_TRADE_SEEL = PERSISTENT_TRADE_STATE_INGAME_TRADE_SEEL,
};
