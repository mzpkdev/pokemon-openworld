...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_COUNT,
    JOHTO_TRAINER_CLASS_BURGLAR = TRAINER_CLASS_COUNT,
    JOHTO_TRAINER_CLASS_FIREBREATHER,
    JOHTO_TRAINER_CLASS_JUGGLER,
    JOHTO_TRAINER_CLASS_PSYCHIC_M,
    JOHTO_TRAINER_CLASS_SAGE,
    JOHTO_TRAINER_CLASS_SUPER_NERD,
    JOHTO_TRAINER_CLASS_COUNT,
};
