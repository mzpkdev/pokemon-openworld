...
def battle_frontier_mons(data):
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_HP,"),
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_ATTACK,"),
        ".ev = TRAINER_PARTY_EVS(0, 252, 0, 0, 0, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SPEED,"),
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_HP,"),
        ".ev = TRAINER_PARTY_EVS(252, 0, 0, 0, 252, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_ATTACK,"),
        ".ev = TRAINER_PARTY_EVS(0, 252, 0, 0, 252, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_DEFENSE,"),
        ".ev = TRAINER_PARTY_EVS(0, 0, 252, 0, 252, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_ATTACK | F_EV_SPREAD_SPEED,"),
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_HP,"),
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_ATTACK,"),
        ".ev = TRAINER_PARTY_EVS(0, 252, 0, 0, 0, 252),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_SP_ATTACK,"),
        ".ev = TRAINER_PARTY_EVS(0, 0, 0, 0, 252, 252),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SP_DEFENSE | F_EV_SPREAD_DEFENSE,"),
        ".ev = TRAINER_PARTY_EVS(0, 0, 252, 0, 0, 252),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_ATTACK | F_EV_SPREAD_HP,"),
        ".ev = TRAINER_PARTY_EVS(252, 252, 0, 0, 0, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_HP,"),
    ...
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_SPEED | F_EV_SPREAD_ATTACK,"),
        ".ev = TRAINER_PARTY_EVS(0, 252, 0, 252, 0, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_HP,"),
        ".ev = TRAINER_PARTY_EVS(252, 0, 252, 0, 0, 0),",
        data,
    )
    data = re.sub(
        re.escape(".evSpread = F_EV_SPREAD_DEFENSE | F_EV_SPREAD_ATTACK,"),
