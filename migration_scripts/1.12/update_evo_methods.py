...
def convert_methods(data):
    ...
    for line in data:
        if "EVO_FRIENDSHIP," in line:
            ...
            new_data = new_data + re.sub(
                pattern,
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_NOT_TIME, TIME_NIGHT})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_TIME, TIME_NIGHT})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                pattern,
                "{EVO_TRADE, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_HOLD_ITEM, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_PID_UPPER_MODULO_10_GT, 5})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_PID_UPPER_MODULO_10_LT, 5})}",
                line,
            )
        ...
        # new_data = new_data = re.sub(pattern, " ", line)
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_GENDER, MON_FEMALE})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_NOT_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_TIME, TIME_NIGHT}, {IF_HOLD_ITEM, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_MIN_FRIENDSHIP, FRIENDSHIP_EVO_THRESHOLD}, {IF_KNOWS_MOVE_TYPE, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_WEATHER, WEATHER_RAIN})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_WEATHER, WEATHER_FOG})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_SPECIES_IN_PARTY, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_TYPE_IN_PARTY, TYPE_DARK})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_TRADE, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_TRADE_PARTNER_SPECIES, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_BATTLE_END, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_CRITICAL_HITS_GE, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_SCRIPT_TRIGGER, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_CURRENT_DAMAGE_GE, "
                + f"{members[CONDTION].strip()}"
                + "})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                pattern,
                "{EVO_SCRIPT_TRIGGER, " + f"0, {members[SPECIES].strip()}" + "}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                pattern,
                "{EVO_SCRIPT_TRIGGER, " + f"1, {members[SPECIES].strip()}" + "}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_PID_MODULO_100_EQ, 0})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"{members[CONDTION].strip()}, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_PID_MODULO_100_GT, 0})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_USED_MOVE_X_TIMES, "
                + f"{members[CONDTION].strip()}"
                + ", 20})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_RECOIL_DAMAGE_GE, "
                + f"{members[CONDTION].strip()}"
                + "}, {IF_GENDER, MON_MALE})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_DEFEAT_X_WITH_ITEMS, "
                + "SPECIES_BISHARP, ITEM_LEADERS_CREST, 3})}",
                line,
            )
            ...
            new_data = new_data + re.sub(
                ...
                "{EVO_LEVEL, "
                + f"0, {members[SPECIES].strip()}"
                + ", CONDITIONS({IF_MIN_OVERWORLD_STEPS, 1000})}",
                line,
            )
        else:
