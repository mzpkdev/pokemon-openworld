...
RULES_NO_SCAN += wild-encounter-test wild-encounter-balance-audit map-catalog-test map-catalog map-atlas-catalog map-atlas-build map-atlas-test map-atlas-browser-test
...
.PHONY: map-catalog-test map-catalog map-atlas-catalog map-atlas-build map-atlas-test map-atlas-browser-test
.PHONY: $(RULES_NO_SCAN)
