...
from Quickstart through receiving the Pokédex. `make e2e-foundation` proves the
...
missing. Run the Foundation suite with:

```sh
make e2e-foundation
```

Foundation uses the generated manifest to structurally initialize every
