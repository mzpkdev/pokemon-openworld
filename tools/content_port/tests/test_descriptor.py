...
class DescriptorTests(unittest.TestCase):
    ...
    def test_checked_port_declares_every_map_and_capability(self):
        ...
        self.assertEqual(
            state_counts,
            {"enabled": 526, "deferred": 2322, "story-owned": 200},
        )
        self.assertEqual(
            {
                domain: item["count"]
        ...
        self.assertEqual(descriptor.trainer_materialization_prefix_count, 4)
        self.assertEqual(
            descriptor.trainer_materialization_prefix_digest,
            "1607fdbd4280bdeaab050f5c4788915dccccc00c913ba546d8e5009c0059763f",
        )
        self.assertEqual(
